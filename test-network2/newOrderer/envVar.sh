...
setNewOrdererGlobals() {
  export CORE_PEER_LOCALMSPID="ExtraMSP"
  export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/../organizations/ordererOrganizations/extra.com/orderers/orderer.extra.com/msp/tlscacerts/tlsca.extra.com-cert.pem
  export CORE_PEER_MSPCONFIGPATH=${PWD}/../organizations/ordererOrganizations/extra.com/users/Admin@extra.com/msp
